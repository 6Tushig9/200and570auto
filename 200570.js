...
const menuShow = document.getElementById('mShow');
const tses = document.getElementById('tses');
menuShow.onclick=function(){
    if(tses.style.display=='flex'){
        tses.style.display='none'
    }
    else{
        tses.style.display='flex'
        tses.style.zIndex='100'
    }
}
...
const mnu1=document.getElementById('mmm1')
const mnu2=document.getElementById('mmm2')
const mnu3=document.getElementById('mmm3')
const mnu4=document.getElementById('mmm4')
const mnu5=document.getElementById('mmm5')


ts1.onclick=function(){
    mnu1.style.display='flex'
    mnu2.style.display='none'
    mnu4.style.display='none'
    mnu5.style.display='none'
    tses.style.display='none'
}
ts2.onclick=function(){
    mnu2.style.display='flex'
    mnu1.style.display='none'
    mnu4.style.display='none'
    mnu5.style.display='none'
    tses.style.display='none'
    tses.style.backgroundImage
    mback.style.backgroundImage='var(--darkglassBGColor)'
    mback.style.backgroundColor='var(--darkglassBGColor)'
}
ts3.onclick=function(){
    footer.scrollIntoView();
    tses.style.display='none'
}
ts4.onclick=function(){
    mnu4.style.display='flex'
    mnu1.style.display='none'
    mnu2.style.display='none'
    mnu5.style.display='none'
    tses.style.display='none'
...
ts5.onclick=function(){
    mnu5.style.display='flex'
    mnu1.style.display='none'
    mnu2.style.display='none'
    mnu4.style.display='none'
    tses.style.display='none'
